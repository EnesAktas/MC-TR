...
exports.run = (client, message, args) => {
  ...
  if (!modlog) return message.reply('[MC-TR] `mod-log` adlı kanalını bulamıyorum.');
  ...
  if (!message.guild.member(user).bannable) return message.reply('Yetkilileri banlamaya yetkim bulunmamakta.');
